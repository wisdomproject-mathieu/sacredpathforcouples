...
const AppLayout = () => {
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <div
        className={`mx-auto flex min-h-screen flex-col px-4 py-4 md:px-6 lg:py-6 ${
          isLibraryRoute ? "max-w-none" : "max-w-7xl lg:flex-row lg:gap-6"
        }`}
      >
        {!isLibraryRoute ? (
        ...
        <main
          className={`min-w-0 flex-1 py-2 ${isLibraryRoute ? "relative z-10 mx-auto w-full max-w-6xl lg:py-4" : "lg:py-0"}`}
        >
          {isLibraryRoute ? (
