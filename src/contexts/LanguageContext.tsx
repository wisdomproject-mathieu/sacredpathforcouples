...
const translations: Record<string, Record<Language, string>> = {
  ...
  // Reconnect premium
  "reconnect.unlock": { en: "Unlock all 6 rituals", fr: "Débloquer les 6 rituels", cs: "Odemknout všech 6 rituálů" },
  "reconnect.unlock_desc": { en: "Access all sacred reconnection rituals with a Sacred subscription. 7 days free.", fr: "Accédez à tous les rituels sacrés avec un abonnement Sacred. 7 jours gratuits.", cs: "Přístup ke všem posvátným rituálům s předplatným Sacred. 7 dní zdarma." },
